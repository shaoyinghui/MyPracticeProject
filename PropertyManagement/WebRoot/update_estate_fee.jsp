...
<html class="no-js">
    ...
    <head>
        ...
        <script type="text/javascript" src = "js/manage_estate_fee.js"></script>
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <ul class="nav">
                            ...
                            <li class="dropdown active">
                                <a href="manage_estate_fee.jsp" role="button" class="dropdown-toggle" data-toggle="dropdown">费用管理<i class="caret"></i>
                                </a>
                                <ul class="dropdown-menu">
                                    <li>
            ...
            <div class="row-fluid">
                <div class="span3" id="sidebar">
                    <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
                        <li>
                            <a href="manage_estate_fee.jsp"><i class="icon-chevron-right"></i>统计信息</a>
                        </li>
                        <li class="active">
                            <a href="update_estate_fee.jsp"><i class="icon-chevron-right"></i>修改费用</a>
                        </li>
                    </ul>
                </div>
                <!--/span-->
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">修改费用</div>
                            </div>
                            <div class="block-content collapse in">
                                <form class = "form-horizontal" id = 'update_estate_fee_form'>
                                  <legend>填写新的物业管理费</legend>
                                  <div class="control-group">
                                    <label class="control-label" for="estate_fee">物业管理费</label>
                                      <div class="controls">
                                        <input class="input-xlarge focused" id="estate_fee" type="text" disabled placeholder="" value = "18">
                                      </div>
                                  </div>
                                  <div class="control-group">
                                    <label class="control-label" for="new_estate_fee">新的物业管理费</label>
                                      <div class="controls">
                                        <input class="input-xlarge focused" name = "new_estate_fee" id="new_estate_fee" type="text" placeholder="" value = "">
                                        <span class = "error_hint"></span>
                                      </div>
                                  </div>
                                  <div class="form-actions">
                                     <button type="button" class="btn btn-primary" id = "submit_new_fee">提交</button>
