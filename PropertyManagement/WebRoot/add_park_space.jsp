...
<html>
    ...
    <body>
                  ...
                  <div class="row-fluid">
                      ...
                      <div class="block">
                          ...
                          <div class="block-content collapse in">
                              <div class="span12">
                                <div class="alert alert-info" id = "house_not_exist" role="alert">
                                  <strong>很抱歉！该业主不存在！</strong>
                                </div>
                                <div class="alert alert-info" id = "park_space_has_been_used" role="alert">
                                  <strong>很抱歉！该车位已被登记！</strong>
                                </div>
                                <div class="alert alert-info" id = "add_park_space_success" role="alert">
                                  <strong>登记车位成功</strong>
                                </div>
                                  <form class="form-horizontal" id = "add_park_space_form">
                                    <fieldset>
                                      <legend>选择业主</legend>
                                      ...
                                      <div class="control-group">
                                        <div class="control-group">
                                          <label class="control-label" for="park_space_id">车位编号</label>
                                          <div class="controls">
                                      ...
                                      <div class="form-actions">
                                        <button type="button" class="btn btn-primary" id = "submit_park_space">提交</button>
        ...
        <!-- Modal 添加车位确认模块 -->
        <div class="modal fade" id="add_park_space_modal" tabindex="-1" role="dialog" style="display: none;" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <table class = "table" id = "add_park_space_config_owner_info">
                  <thead>
                    <th>姓名</th>
                    <th>电话</th>
                    <th>邮箱</th>
                ...
                <hr>
                <h4>是否确定要为该业主登记车位？</h4>
                <p id = "config_park_space">车位编号：</p>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal" id = "cancel_add">取消</button>
                <button type="button" class="btn btn-primary" id = "add_park_space">确定</button>
              </div>
            </div>
          </div>
        </div>
