...
<html>
    ...
    <body>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    <form class="form-horizontal">
                                      <fieldset>
                                        ...
                                        <div class="form-actions">
                                          <button type="button" id = "submit_select_vehicle" class="btn btn-primary">确定</button>
                                    ...
                                    <div class='alert alert-info' id = 'no_owner' role='alert'>
                                      <strong>没有登记任何车辆</strong>
                                    </div>
                                    <table class = "table" id = "show_vehicle_info">
                                      <thead>
                                        <tr>
                                          <th>车牌号码</th>
                                          <th>登记时间</th>
         ...
         <hr>
        <!-- Modal 删除车辆信息 -->
        <div class="modal fade" id="delete_vehicle_modal" tabindex="-1" role="dialog" style="display: none;" aria-labelledby="myModalLabel">
        ...
        <!-- Modal 修改车辆信息 -->
        <div class="modal fade" id="update_vehicle_modal" tabindex="-1" role="dialog" style="display: none;" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              ...
              <div class="modal-body">
                <form id = "update_vehicle_form">
                  <div class="control-group">
                    <label class="control-label" for="new_vehicle_plate">新的车牌号码</label>
                    <div class="controls">
                      <input class="input-xlarge focused" id="new_vehicle_plate" type="text" placeholder="粤E12C26">
